...
#define CUSTOM_MACHINE_NAME "Starlos Ender-3 Pro"
 ...
 */
#define BLTOUCH // Starlos - using BLTouch
...
#define PROBING_MARGIN 15 // Starlos - trying to keep it away from clips and edges
